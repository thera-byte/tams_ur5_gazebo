...
class TupleClass:
    ...
    def iterate_movements(self, g, g1, g2):
        ...
        if self.counter >= iterations or self.endstate == [1,1,1]:
            ...
            #if counter >= g or self.endstate == [1,1,1]:
            #    arm_pose_3 = self.make_arm_pose( [ -2.34, -2.33, -1.75, -1.70, -1.5, -3.10 ] )
    ...
    def calculate_new_pose(self, g, g1, g2):    
        ...
        print("middle current jointsstate 1:", self.current_jointstates[6])
        ...
        print("middle current jointsstate 2:", self.current_jointstates[7])
        ...
        print("middle current jointsstate 3:", self.current_jointstates[8])
        ...
        print("f1 current jointsstate 1:", self.current_jointstates[0])
        ...
        print("f2 current jointsstate 1:", self.current_jointstates[3])
        ...
        print("f2 current jointsstate 2:", self.current_jointstates[4])
    ...
    def move_to_pose(self, g, g1, g2): 
        ...
        if self.endstate == [1, 0, 0]:
            ...
            print("middle finger new positions:", self.current_jointstates[6], self.current_jointstates[7], self.current_jointstates[8] )
            new_pos_finger_middle_joint_1 = self.current_jointstates[6]
            new_pos_finger_middle_joint_2 = self.current_jointstates[7]
            new_pos_finger_middle_joint_3 = self.current_jointstates[8]
        elif self.endstate == [0, 1, 0]:
            print("finger 1 endstate gets different new positions now", self.endstate)
            print("f1 new positions:", self.current_jointstates[0], self.current_jointstates[1], self.current_jointstates[2] )
            new_pos_finger_1_joint_1 = self.current_jointstates[0]  
            new_pos_finger_1_joint_2 = self.current_jointstates[1] 
            new_pos_finger_1_joint_3 = self.current_jointstates[2]
        elif self.endstate == [0, 0, 1]:
            print("finger 2 endstate gets different new positions now", self.endstate)
            print("f2 new positions:", self.current_jointstates[3], self.current_jointstates[4], self.current_jointstates[5] )
            new_pos_finger_2_joint_1 = self.current_jointstates[3]    
            new_pos_finger_2_joint_2 = self.current_jointstates[4]
            new_pos_finger_2_joint_3 = self.current_jointstates[5]
        if self.endstate == [1, 1, 0]:
            ...
            new_pos_finger_1_joint_2 = self.current_jointstates[1] 
            new_pos_finger_1_joint_3 = self.current_jointstates[2]
            print("f2 new positions:", self, self.current_jointstates[3], self.current_jointstates[4], self.current_jointstates[5] )
            new_pos_finger_2_joint_1 = self.current_jointstates[3]    
            new_pos_finger_2_joint_2 = self.current_jointstates[4]
            new_pos_finger_2_joint_3 = self.current_jointstates[5]
