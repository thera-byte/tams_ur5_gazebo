...
# arm positionieren
        ...
        #def pinch_mode(self):
         #       gripper_pinch_pose = self.make_basic_gripper_pose(0.10, 0.02, -0.10, 0.10, 0.02, -0.10, 0.10, 0.02, -0.10)
...
if __name__ == "__main__":
        ...
        tube_pose = Pose()
        tube_pose.position.x = 1.045 
        tube_pose.position.y = 0.805
        tube_pose.position.z = 0.80 
        x.setup()
        rospy.sleep(3)
        x.spwan_model('/.gazebo/models/tube_9_5mm/model.sdf', tube_pose)
        x.start_bag_record()
        x.perform_grasp(254, 254, 254)
        rospy.sleep(3)
        x.stop_bag_record()
