...
class MoveFingers:
    ...
    def iterate_movements(self, g, g1, g2):
        ...
        if self.counter >= iterations or self.endstate == [1,1,1]:
            ...
            self.end_joint_states.position = self.new_poses
    ...
    def calc_delta_theta_f1(self, g1):
        ...
        elif self.tuple_f1[1] == 0 and self.tuple_f1[2] == 0 and self.tuple[3] == 1 and self.tuple_f1[4] == 1 and self.tuple_f1[5] == 0:
            #[., 0, 0, ., 1, 0]:
    ...
    def calc_delta_theta_f2(self, g2):
        ...
        elif self.tuple_f2[1] == 0 and self.tuple_f2[2] == 0 and self.tuple_f2[3] == 0 and self.tuple_f2[4] == 1 and self.tuple_f2[5] == 0:    
    ...
    def calculate_new_pose(self, g, g1, g2):    
        ...
        #if new_pos_finger_middle_joint_3 > -0.06:
            #new_pos_finger_middle_joint_3 = -0.06
        ...
        #if new_pos_finger_1_joint_3 > -0.06:
            #new_pos_finger_1_joint_3 = -0.06
        ...
        #if new_pos_finger_2_joint_3 > -0.06:
            #new_pos_finger_2_joint_3 = -0.06
